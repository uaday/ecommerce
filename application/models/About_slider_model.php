...
class About_slider_model extends CI_Model {
    ...
    {
        $sql="SELECT * from tbl_about_slider WHERE slider_id='$slider_id'";
        $this->db->query("set character_set_results='utf8'");
        $result=$this->db->query($sql);
        return $result->result_array();
    }
    public function add_new_slider($data)
    {
        ...
        $this->db->insert('tbl_about_slider', $data1);
        return 1;
    }
    public function update_slider($data)
    {
        ...
        $this->db->update('tbl_about_slider', $data1);
        return 1;
    }

    public function block_slider($slider_id)
    {
        $sql="UPDATE tbl_about_slider SET status='0' WHERE slider_id='$slider_id'";
        $this->db->query($sql);
    }
    public function active_slider($slider_id)
    {
        $sql="UPDATE tbl_about_slider SET status='1' WHERE slider_id='$slider_id'";
        $this->db->query($sql);
    }
    public function delete_slider($slider_id)
    {
        ...
        unlink($row['0']['image']);
        $this->db->delete('tbl_about_slider', array('slider_id' => $slider_id));
        return 1;
    }
