...
<head>
    ...
    <!-- Animation Css -->
    <link href="<?php echo base_url()?>asset/admin/plugins/animate-css/animate.css" rel="stylesheet" />
...
<script src="<?php echo base_url()?>asset/admin/js/pages/examples/sign-in.js"></script>
